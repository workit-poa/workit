...
library UniswapV2Library {
	...
	/// @notice Given some amount of asset A, returns equivalent amount of asset B
	function quote(
		uint256 amountA,
		uint256 reserveA,
		uint256 reserveB
	...
	/// @notice Returns maximum output amount of the other asset
	...
	/// @notice Returns required input amount for a desired output amount
